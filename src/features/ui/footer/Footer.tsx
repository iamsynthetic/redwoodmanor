...
const Footer = ({ backgroundColor = "bg-base-content" }) => {
  ...
  return (
    ...
    //     {/* First Row - Right justified with button columns */}
    //     <div className="flex flex-col md:flex-row md:justify-end mb-8 w-full h-[max-content] ">
    //       <div className="flex flex-col md:flex-row gap-8 md:gap-56 md:ml-auto">
    //         {/* Two columns of buttons */}
    //         <div className="flex flex-col sm:flex-row gap-6 md:gap-56">
    //           {leftColumnButtons.map((column, colIndex) => (
    //             <div key={colIndex} className="flex flex-col space-y-3">
    //               {column.title && column.title.trim() !== "" ? (
    //                 <h3 className="montserratlight text-neutral-content text-[40px] mb-2">
    //                   {column.title}
    //                 </h3>
    //               ) : (
    //                 <div className="mb-2 h-12 mt-[12px]" /> // 48px matches text-[40px] + margin
    //               )}
    //               {column.items.map((button, btnIndex) => (
    //                 <button
    //                   key={btnIndex}
    //                   id={`btn-${colIndex}${btnIndex}`}
    //                   className="text-left text-xl cardoregular cursor-pointer"
    //                   onMouseEnter={() =>
    //                     handleMenuItemMouseEnter(
    //                       String(colIndex) + String(btnIndex)
    //                     )
    ...
    //               <button
    //                 key={index}
    //                 className="text-left text-xl cardoregular"
    //               >
    //                 {button}
    //               </button>
    //             ))}
    ...
    //       <h2 className="montserratlight text-[64px] mb-2 text-left">
    //         Redwood Manor
    //       </h2>
    //     </div>
    ...
    //           ))}
    //         </div>
    //         <div className="text-left text-xl cardoregular whitespace-nowrap">
    //           © 2025 Redwood Manor. All rights reserved.
    //         </div>
    //       </div>
    //     </div>
